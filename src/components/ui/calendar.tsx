...
function Calendar({
  ...
  // Add custom CSS to improve date range styling
  React.useEffect(() => {
    if (typeof window !== 'undefined') {
      const styleId = 'calendar-range-styles';
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_middle:
          "aria-selected:bg-accent/70 aria-selected:text-accent-foreground hover:bg-accent/70 hover:text-accent-foreground rounded-none",
